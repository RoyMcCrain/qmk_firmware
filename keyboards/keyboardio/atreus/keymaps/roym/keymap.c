 ...
 */
  [_ASTARTE] = LAYOUT(
      KC_Q,    KC_P,    KC_U,    KC_Y,                    KC_ESC,  KC_J,   KC_D,  KC_H,    KC_G,    KC_W,
      KC_I,    KC_O,    KC_E,    KC_A,                    KC_CENT, KC_K,   KC_T,  KC_N,    KC_S,    KC_R,
      KC_Z,    KC_X,    KC_SLSH, KC_C,  KC_SCLN, KC_LALT, KC_RSFT, KC_M,   KC_L,  KC_F,    KC_B,    KC_V,
 ...
 */
  [_LOWER] = LAYOUT(
      ...
      _______, _______, V_Q,     V_W,     V_WQ,    _______, _______, V_SV,    V_CV,     _______, _______, _______,
 ...
 */
  [_RAISE] = LAYOUT(
      ...
      KC_GRV,  KC_BSLS, KC_EQL,  KC_SLSH, KC_MINUS,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
      UNDO,    CUT,     COPY,    KC_LPRN, KC_LBRC,  _______, _______, KC_RBRC, KC_RPRN, V_CD,    V_CU,    _______,
      _______, _______, KC_AESC, _______, KC_TAB,   KC_TAB,  _______, _______, _______, _______, _______, _______ 
  ),
