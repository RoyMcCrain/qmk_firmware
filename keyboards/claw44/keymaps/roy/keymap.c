...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------/     \--------+--------+--------+--------+--------+--------|
                  CTL_T(KC_ESC),   LOWER,  KC_SPC,  KC_TAB,       KC_SAVE,  KC_ENT,   RAISE, KC_BSPC \
                    //`-----------------------------------'     '-----------------------------------'
    ),
  ...
  //|--------+--------+--------+--------+--------+--------/     \--------+--------+--------+--------+--------+--------|
                        _______,   LOWER,  KC_SPC,  KC_TAB,       KC_SAVE, KC_CENT,   RAISE, KC_DEL \
                    //`-----------------------------------'     '-----------------------------------'
    ),
  ...
  //|--------+--------+--------+--------+--------+--------/     \--------+--------+--------+--------+--------+--------|
                        KC_LGUI,   LOWER,  KC_TAB,  KC_TAB,       KC_SAVE,  KC_ENT,   RAISE, KC_BSPC \
                    //`-----------------------------------'     '-----------------------------------'
    ),
  ...
  //|--------+--------+--------+--------+--------+--------/     \--------+--------+--------+--------+--------+--------|
                        _______, _______, XXXXXXX, XXXXXXX,       XXXXXXX, KC_BTN2, KC_BTN1, XXXXXXX \
                    //`-----------------------------------'     '-----------------------------------'
    ),
