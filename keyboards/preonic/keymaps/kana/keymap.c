...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_preonic_grid(
      KC_1,    KC_2,    KC_3,           KC_4,             KC_5,   KC_SLSH, KC_BSLS, KC_6,   KC_7,  KC_8,    KC_9,   KC_0, \
      KC_Q,    KC_W,    KC_E,           KC_R,             KC_T,   KC_EQL,  KC_GRV,  KC_Y,   KC_U,  KC_I,    KC_O,   KC_P, \
      KC_A,    KC_S,    KC_D,           KC_F,             KC_G,   KC_QUOT, KC_MINS, KC_H,   KC_J,  KC_K,    KC_L,   KC_SCLN, \
      KC_Z,    KC_X,    KC_C,           KC_V,             KC_B,   KC_LBRC, KC_RBRC, KC_N,   KC_M,  KC_COMM, KC_DOT, KC_SLSH, \
      KC_LALT, KC_LCTL, LGUI_T(KC_ESC), LSFT_T(KC_LANG2), KC_SPC, KC_TAB,  KC_BSPC, KC_ENT, RAISE, KC_RCTL, KC_DEL, KC_RSFT
    ),
    ...
    [_RAISE] = LAYOUT_preonic_grid(
      ...
      UNDO,    CUT,     COPY,    PSTE,    KC_LBRC,  KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______, \
