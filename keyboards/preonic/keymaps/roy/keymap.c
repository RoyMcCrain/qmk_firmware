 ...
 * |   Z  |   X  |   C  |   V  |   B  |  [   |  ]   |   N  |   M  |   ,  |   .  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GUI  |  Alt | Ctrl | SFT  |    Space    |    Ente     | Raise| BCSP | SFT  | Del  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LGUI, KC_LALT, CTL_T(KC_ESC), KC_RSFT, KC_SPC, KC_SPC,  KC_ENT,  KC_ENT,  RAISE,   KC_BSPC, KC_RSFT, KC_DEL
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  UNDO,    CUT,     COPY,    _______, KC_LBRC,  KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______,
